...
see the related http://github.com/github.com/shengjh/keydbr which allows remote access to a keydb instance, and allows a keydb database to be shared by multiple processes
